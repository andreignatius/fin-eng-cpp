...
class EuropeanOption : public TreeProduct {
  public:
    ...
    //   EuropeanOption(OptionType _optType, double _strike, const Date&
    //   _expiry, string _underlying):
    // optType(_optType), strike(_strike), expiryDate(_expiry),
    ...
    EuropeanOption(OptionType optType, double strike, const Date &expiry,
        ...
        : TreeProduct("EuropeanOption", expiry,
                      underlying), // Assuming TreeProduct constructor is
                                   // correctly set up to take these parameters
          optType(optType), strike(strike), expiryDate(expiry),
